 ...
 * 对象数组的String属性非空校验
 *
 * @author on 2021/03/31
 */
@Slf4j
public class ObjectArrayNotBlankFieldValidator extends Validator {

    private static ObjectArrayNotBlankFieldValidator instance;

    public static Validator getInstance() {
        if (instance == null) {
            instance = new ObjectArrayNotBlankFieldValidator();
        }
        return instance;
    }
    ...
    public ValidateResult validate(Object param, Validate validate) throws Throwable {
        ...
        try {
            ...
            if (!returnType.isArray()) {
                log.warn("there is no public getter method returning array for field {} in class {}", fields,
                        paramType.getName());
                return result;
            }
            ...
            for (String field : deepFields) {
                ...
                try {
                    ...
                    if (!Objects.equals(String.class, getMethod.getReturnType())) {
                        log.warn("there is no public getter returning java.lang.String for field {}.{} in class{}",
                                targetField, field, elementType.getName());
                        continue;
                    }
                ...
                for (int i = 0; i < values.length; i++) {
                    ...
                    if (value != null) {
                        String deepValue = (String) getMethod.invoke(value);
                        if (deepValue == null || deepValue.length() == 0) {
